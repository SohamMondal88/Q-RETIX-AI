...
const articles = allPosts.slice(0, 4).map((p) => ({
  id: p.slug,
  title: p.title,
  description: p.description,
  category: p.category,
  readTime: p.readTime.replace(" min read", " min"),
  date: p.date,
  author: p.author,
  image: p.image,
  slug: p.slug,
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[100dvh] flex flex-col lg:flex-row items-center justify-center max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 gap-8 lg:gap-16 py-12 lg:py-0">
        ...
        >
          <div className="relative w-full max-w-[420px]" style={{ height: "min(480px, 65vh)" }}>
      ...
      <div ref={ctaRef} className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">

...
export const blogPosts: BlogPostData[] = [
  {
    ...
    body: (
      <>
        ...
        <h2 id="executive-summary" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">Executive Summary</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h2 id="the-aim2-paradox" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">1. The AIM2 Paradox: A Critical Node in Innate Immunity</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Structural Topography of the Basal Autoinhibited State</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <ul className="list-disc pl-5 space-y-3 text-[#5A6B82] mb-6">
          <li><strong>The N-Terminal Pyrin Domain (PYD):</strong> Spanning residues 1-94, the PYD acts as the signaling hub. It possesses a canonical six-helix death-domain fold characterized by an asymmetric charge distribution.</li>
          <li><strong>The C-Terminal HIN-200 Domain:</strong> Spanning residues 138-343, this domain features tandem OB-folds heavily enriched with lysine and arginine residues. This creates a highly basic, positively charged surface optimized for binding non-sequence-specific nucleic acids (dsDNA).</li>
        </ul>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <p className="text-sm text-[#5A6B82] italic mb-8">
          Figure 1: Comprehensive Insights into AIM2-like Receptor Biology and Targeting.
        </p>

        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">The Pathological Activation Cascade</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <p className="text-[#5A6B82] leading-relaxed mb-4">The activation involves a dramatic macromolecular cascade:</p>
        <ol className="list-decimal pl-5 space-y-3 text-[#5A6B82] mb-8">
          <li><strong>Ligand Engagement:</strong> Cytosolic dsDNA outcompetes the intramolecular PYD-HIN bond.</li>
          <li><strong>Filament Nucleation:</strong> The flexible hinge rotates, exposing the PYD. Monomers rapidly stack to form massive filamentous structures.</li>
          <li><strong>ASC Speck Assembly &amp; Pyroptosis:</strong> The PYD filament recruits ASC adapter proteins, forming an &ldquo;ASC Speck.&rdquo; This activates Pro-Caspase-1, which aggressively cleaves interleukins (IL-1&beta;, IL-18) and Gasdermin D (GSDMD), culminating in pore-mediated pyroptosis.</li>
        </ol>

        <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/1blog1.jpg" alt="AIM2 Receptor Biology and Targeting" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h2 id="the-traditional-bottleneck" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">2. The Traditional Bottleneck: The Electrostatic &ldquo;Charge Trap&rdquo;</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">1. The Permeability Penalty</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">2. The Pan-Sensor Cross-Reactivity Risk</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-8">
        ...
        <h2 id="enter-q-retixai" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">3. Enter Q-RETIX.AI: Redefining Target Discovery</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Discovery of the Hydrophobic Interdomain Hinge Node</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <p className="text-sm text-[#5A6B82] italic mb-6">
          Figure 2: The Electrostatic Charge Trap vs. The Q-RETIX.AI Approach.
        </p>

        <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/1blog2.jpg" alt="Electrostatic Charge Trap vs Q-RETIX.AI Approach" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">The Allosteric Molecular Wedge</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h2 id="comparative-pharmacology" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">4. Comparative Pharmacology: A Paradigm Shift in Drug Design</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <div className="overflow-x-auto mb-8">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="text-[#5A6B82]">
              <tr className="border-b border-[#E6EEF2] bg-white"><td className="px-4 py-3 font-medium text-[#33415C]">Target Domain Face</td><td className="px-4 py-3">Basic HIN-200 patch</td><td className="px-4 py-3">Hydrophobic interdomain hinge pocket</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-[#F8FAFB]"><td className="px-4 py-3 font-medium text-[#33415C]">Net Charge</td><td className="px-4 py-3">Highly Anionic (-)</td><td className="px-4 py-3">Neutral</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-white"><td className="px-4 py-3 font-medium text-[#33415C]">Polar Surface Area</td><td className="px-4 py-3">Extremely High</td><td className="px-4 py-3">Low (Lipophilic)</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-[#F8FAFB]"><td className="px-4 py-3 font-medium text-[#33415C]">Mechanism of Action</td><td className="px-4 py-3">Competitive displacement of DNA</td><td className="px-4 py-3">Allosteric hinge stabilization</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-white"><td className="px-4 py-3 font-medium text-[#33415C]">Membrane Permeability</td><td className="px-4 py-3">Severely Restricted</td><td className="px-4 py-3">Highly Efficient</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-[#F8FAFB]"><td className="px-4 py-3 font-medium text-[#33415C]">cGAS / Off-Target Selectivity</td><td className="px-4 py-3">Poor (Pan-sensor binding)</td><td className="px-4 py-3">Excellent (Hinge-specific)</td></tr>
              <tr className="bg-white"><td className="px-4 py-3 font-medium text-[#33415C] rounded-bl-xl">Clinical Toxicity Risk</td><td className="px-4 py-3">High</td><td className="px-4 py-3 rounded-br-xl">Low</td></tr>
            </tbody>
          </table>
        </div>
        ...
        <h2 id="reviving-a-dormant-market" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">5. Reviving a Dormant Multi-Billion Dollar Market</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Target Indications</h3>
        ...
        <ul className="list-disc pl-5 space-y-3 text-[#5A6B82] mb-6">
          <li><strong>Systemic Autoimmunity:</strong> Downregulating AIM2 directly curtails the excessive DNA-sensing feedback loops characteristic of Systemic Lupus Erythematosus (SLE) and Rheumatoid Arthritis.</li>
          <li><strong>Autoinflammatory Dermatoses:</strong> Psoriasis and related skin pathologies heavily rely on AIM2-driven IL-1&beta; and IL-18 maturation. Blocking ASC speck assembly provides a direct, upstream intervention compared to current biologic therapies.</li>
          <li><strong>Metabolic &amp; Neurodegenerative Disorders:</strong> Emerging data links chronic AIM2 activation to sterile inflammation in atherosclerosis and select neurodegenerative conditions. An orally bioavailable, highly permeable inhibitor opens the door to treating the chronic inflammatory components of these systemic diseases.</li>
        </ul>
        <p className="text-sm text-[#5A6B82] italic mb-8">
        ...
        <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/1blog3.jpg" alt="AIM2 Therapeutic Market and Indications" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h2 id="conclusion" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">6. Conclusion: The Power of AI in Structural Biology</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <h2 id="the-diabetes-paradox" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">1. The Diabetes Paradox: Treating Glucose Instead of Disease</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Structural Architecture of Metabolic Homeostasis</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <div className="relative w-full aspect-[15/7] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/2blog1.jpg" alt="SREBF1 Pathological Activation" fill className="object-contain" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h2 id="the-traditional-bottleneck" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">2. The Traditional Bottleneck: Downstream Thinking</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">The Lipotoxicity Cascade</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-4">
        ...
        <h2 id="enter-q-retix-ai" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">3. Enter Q-RETIX AI: Redefining Target Discovery</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <div className="relative w-full aspect-[3/2] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/2blog2.jpg" alt="SREBF1 Systems-Level Influence" fill className="object-contain" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h2 id="comparative-pharmacology" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">4. Comparative Pharmacology: A Systems Biology Approach</h2>
        <div className="overflow-x-auto mb-8">
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-[#2C4D78] text-white">
            ...
            <tbody className="text-[#5A6B82]">
              <tr className="border-b border-[#E6EEF2] bg-white"><td className="px-4 py-3 font-medium text-[#33415C]">Therapeutic Target</td><td className="px-4 py-3">Individual enzymes</td><td className="px-4 py-3">Master transcription factor</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-[#F8FAFB]"><td className="px-4 py-3 font-medium text-[#33415C]">Biological Scope</td><td className="px-4 py-3">Single pathway</td><td className="px-4 py-3">Entire metabolic network</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-white"><td className="px-4 py-3 font-medium text-[#33415C]">Compensation Risk</td><td className="px-4 py-3">High</td><td className="px-4 py-3">Significantly reduced</td></tr>
              <tr className="border-b border-[#E6EEF2] bg-[#F8FAFB]"><td className="px-4 py-3 font-medium text-[#33415C]">Inflammatory Control</td><td className="px-4 py-3">Indirect</td><td className="px-4 py-3">Direct</td></tr>
              <tr className="bg-white"><td className="px-4 py-3 font-medium text-[#33415C] rounded-bl-xl">Disease Modification</td><td className="px-4 py-3">Limited</td><td className="px-4 py-3 rounded-br-xl">Potential systems-level correction</td></tr>
            </tbody>
          </table>
        </div>
        <p className="text-[#5A6B82] leading-relaxed mb-8">
        ...
        <h2 id="target-validation" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">5. Target Validation and Mechanistic Logic</h2>

        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Nuclear Transcriptional Control</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Immunometabolism Integration</h3>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
        ...
        <h2 id="therapeutic-implications" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">6. Therapeutic Implications</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
          Modulating SREBF1 may benefit disorders characterized by pathological lipid metabolism:
        </p>

        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Type 2 Diabetes Mellitus</h3>
        <ul className="list-disc pl-5 space-y-3 text-[#5A6B82] mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Non-Alcoholic Fatty Liver Disease (NAFLD)</h3>
        <ul className="list-disc pl-5 space-y-3 text-[#5A6B82] mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Metabolic Syndrome</h3>
        <ul className="list-disc pl-5 space-y-3 text-[#5A6B82] mb-6">
        ...
        <div className="relative w-full aspect-[3/2] rounded-2xl overflow-hidden bg-[#F8FAFB] border border-[#E6EEF2] mb-8">
          <Image src="/images/blog/2blog3.jpg" alt="Therapeutic Implications of SREBF1 Modulation" fill className="object-contain" sizes="(max-width: 1024px) 100vw, 800px" />
        </div>

        <h3 className="text-xl font-semibold text-[#33415C] mt-8 mb-3">Cardiovascular Disease</h3>
        ...
        <h2 id="discovery-framework" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">7. The Q-RETIX AI Discovery Framework</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
          The discovery process involved four computational stages:
        </p>
        <ol className="list-decimal pl-5 space-y-3 text-[#5A6B82] mb-8">
          <li><strong>Literature Intelligence</strong></li>
          <li><strong>Systems Biology Network Construction</strong></li>
          <li><strong>Regulatory Node Prioritization</strong></li>
          <li><strong>Mechanistic Validation</strong></li>
        </ol>
        <p className="text-[#5A6B82] leading-relaxed mb-8">
        ...
        <h2 id="conclusion" className="text-2xl font-bold text-[#33415C] mt-12 mb-4 scroll-mt-32">Conclusion: AI Beyond Prediction</h2>
        <p className="text-[#5A6B82] leading-relaxed mb-6">
